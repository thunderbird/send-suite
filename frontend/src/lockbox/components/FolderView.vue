      ...
      <div class="lockbox-folder" :class="{ active: folder.id === folderId }">
        <a href="#" @click.prevent="loadFolder(folder.id)">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
            <g transform="matrix(.04235 0 0 .04193 12.359-25.862)" fill="#60aae5" stroke="#4f96d1">
              <g fill="#70cbe2">
                <path transform="matrix(.7872 0 0 .79524 415.34 430.11)"
                ...
                <path
                  ...
                  transform="matrix(23.61017 0 0 23.85134-291.8 616.81)" stroke="#70cbe2" stroke-width=".079" />
              </g>
              <rect transform="matrix(.7872 0 0 .79524 415.34 430.11)" y="356.85" x="-890.28" height="295.13"
                width="463.85" fill="none" stroke="#70cbe2" stroke-linejoin="round" stroke-linecap="round"
      ...
      <template v-if="folder.id === folderId">
        ...
        <ul class="file-list">
          <li v-for="file of folder.items">
            ...
            <a href="#" @click.prevent="selectFile(file.id)">
              [Share]
            </a>
          </li>
        </ul>
